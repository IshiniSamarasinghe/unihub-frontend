...
function Hero() {
    return (
        ...
        >
            <h1 style={{ fontSize: '2rem', marginBottom: '0.4rem', marginTop: '0.1rem', fontFamily: 'Playfair Display, serif', fontWeight: 'normal'}}>
                Welcome to UniHub<br></br>Your Campus, Connected.
            </h1>
            <p style={{ fontSize: '0.7rem', maxWidth: '700px', marginBottom: '1.5rem', marginTop: '0.1rem' }}>
