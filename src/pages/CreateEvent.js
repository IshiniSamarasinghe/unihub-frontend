  ...
  useEffect(() => {
    axios.get('/user')
      ...
      .catch(err => {
        ...
        setUserType('normal_user'); // fallback
      });
  }, []);
      ...
      <div className="create-right">
        ...
        {userType === 'normal_user' ? (
          <div className="no-access-message">
            ❌ You don’t have access to create events. Please contact your society admin.
          </div>
        ) : userType === 'super_user' ? (
          <form className="event-form" onSubmit={handleSubmit}>
            ...
            <div className="form-row">
              ...
              <select name="society" value={formData.society} onChange={handleInputChange} required>
                <option value="">Your Society:</option>
              ...
              >
                ...
                <option
                  value="president"
                  disabled={['president', 'vicepresident'].includes(formData.position)}
                >
                  President
                </option>
                <option
          ...
          <p>Loading...</p> // while userType is null
        )}
      </div>
    </div>
  );
